...
public class Game1 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // 种子/录制生命周期按"局"管理（Game1 是每局入口）
        // 如果 ReplayManager 还没起来，先确保它存在
        ...
        {
            Debug.Log($"[ReplayManager] 进入 Game1 回放模式，SimTime={SimClock.SimTime:F2}");
        }

        // 无论什么路径走到这里，都显式 Reset SimClock 到 0 —— 确保游戏逻辑时间从 0 开始
        SimClock.Reset();
        Debug.Log($"[ReplayManager] Game1.Awake 强制 Reset SimClock → SimTime={SimClock.SimTime:F2}");
    }
